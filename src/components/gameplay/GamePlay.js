...
const GamePlay = ({ gameStart, handleGameStartYes, handleGameStartNo, coins, currentPlayer, handleCoinPick }) => {
    ...
    return (
        ...
        <div className="flex flex-col px-34 items-center pt-20">
            ...
            {/* Start */}
            {/* Decide who will start the */}
            {gameStart === '' ? (
                <StartGame handleGameStartNo={handleGameStartNo} handleGameStartYes={handleGameStartYes} />
            ) : (<>

                {/* Turn of player or AI */}
                <div className="font-semibold text-slate-400 text-4xl mb-2">
